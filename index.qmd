...
<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" viewBox="0 0 100 125" xml:space="preserve" class="svg-quote">
  ...
  <p class="quote-copy" style="color:white;"> <i>Mastering the art of timing enables us to fast-track your travel experience. We help people do business. </i>
</p>
...
<div class="layout_grid">
    <div class="quote-container">
        <h1 class="quote-text scroll-text">“Be the change that you wish to see in the world.”</h1>
        <p class="quote-author scroll-text">― Mahatma Gandhi</p>
    </div>
...
<div class="achievements">
  <div class="work">
    <div class="work-icon">
      ...
      <p class="work-heading scroll-text">Projects</p>
    </div>
    <div class="work-description">
      <p class="work-text scroll-text">I have worked on many projects and I am very proud of them. I am a very good developer and I am always looking for new projects.</p>
    </div>
  </div>
  <div class="work">
    <div class="work-icon">
      <i class="fas fa-skiing"></i>
      <p class="work-heading scroll-text">Skills</p>
    </div>
    <div class="work-description">
      <p class="work-text scroll-text">I have a lot of skills and I am very good at them. I am very good at programming and I am always looking for new skills.</p>
    </div>
  </div>
  <div class="work">
    <div class="work-icon">
      <i class="fas fa-award"></i>
      <p class="work-heading scroll-text">Awards</p>
    </div>
    <div class="work-description">
      <p class="work-text scroll-text">I have received many awards for my work and I am very proud of them. I am a very talented developer and I always strive for excellence.</p>
    </div>
  </div>
  <div class="work">
    <div class="work-icon">
      <i class="fas fa-globe"></i>
      <p class="work-heading scroll-text">Experience</p>
    </div>
    <div class="work-description">
      <p class="work-text scroll-text">I have a lot of experience in web development and I have worked with many clients. I am a very reliable and professional developer.</p>
    </div>
  </div>
  <div class="work">
    <div class="work-icon">
      <i class="fas fa-briefcase"></i>
      <p class="work-heading scroll-text">Portfolio</p>
    </div>
    <div class="work-description">
      <p class="work-text scroll-text">I have a strong portfolio of work that showcases my skills and experience as a developer. I am always proud to share my work with others.</p>
    </div>
  </div>
</div>
...
<a href="https://twitter.com/HertieCodingCLB">
  ...
  <a href="https://github.com/your-github-username">
    <img src="https://twitter.com/HertieCodingCLB" alt="GitHub icon" style="margin: 0 10px; height: 35px;">
  </a>
