...
<h1 class="scroll-text back_resource" style="display: flex; align-items: center; justify-content: center; border-radius: 10px; font-weight: 700;
  color: white;
  font-size: 50px;">
...
:::
  ...
  <div>
<h1 class="scroll-text back_resource" style="display: flex; align-items: center; justify-content: center; border-radius: 10px;
  font-weight: 900;
  color: white;
  font-size: 50px;">
