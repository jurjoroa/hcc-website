...
<h1 class="scroll-text">{{< li aefjguud trigger=loop delay=1000 scale=25 >}}Resources</h1>

<div style = "margin-top: 35px;"> </div> 

This section includes online resources that provide step-by-step tutorials and guides for the people that is interested in learning code. Feel free to check them out. We are adding resources constantly.
...
:::
::: {.g-col-7}
{{< li azartkjs trigger=loop delay=1000 scale=50 >}} Learn R
:::
::: {.g-col-1}
:::
:::
...
<div class="layout_grid_books">
 ...
 <div class="social-media-mobile3">
 
 <h1 class="scroll-text book_style_mob"> Books </h1>
...
<h1 class="scroll-text book_style_desktop"> Books </h1>
...
<h1 class="scroll-text certification_style_desktop"> Certifications </h1>
<h1 class="scroll-text certification_style_mobile"> Certifications </h1>
