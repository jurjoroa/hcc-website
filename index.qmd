...
<div class="layout_grid_6">
<a style="padding: 1% 12%;" href="../events/index.html"> <button type="button" class="btn btn-primary float-end btn-sm">See all/Ver todos</button></a>
