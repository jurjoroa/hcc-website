...
<h1 class="scroll-text social-media">Follow{{< li kjkiqtxg trigger=loop delay=1000 scale=25 >}}</h1>
...
:::
::: {.g-col-4}
![](_site/images/hertie/DSL.png){width="141" height="36" fig-align="center"}
:::
::: {.g-col-4}
