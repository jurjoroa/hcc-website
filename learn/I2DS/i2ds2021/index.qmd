---
title:  '{{< animate fadeInDown "I2DS Tools for Data Science Workshop 2021"delay=.6s >}}'
...
<div>
  <form action="https://intro-to-data-science-21-workshop.github.io">
    <button class="button_i2ds" type="submit">
       <i class="fa-solid fa-screwdriver-wrench fa-2x"></i></i> Go to I2DS Tools 2021
    </button>
  </form>
</div>
