---
title:  '{{< animate fadeInDown "Understanding R Objects: Data Structures and Classes in R"delay=.6s >}}'
subtitle: '{{< animate fadeInDown "This is why R is so powerful: all kind of objects and possibilites"delay=.6s >}}'
author: ["Jorge Roa"]
date: "2023-04-16"
...
listing: 
  - id: eda
    contents: "material/Books/eda_r/index.qmd"
    type: grid
---
...
1.- Using `data.frame()` function: This is the most common way to create a data frame in R. You can put as many vectros (variables) as you want. 
...
You can check our other tutorials to handle dataframes and start practicing. We also recommend this books 
