...
::: {layout="[[-1], [1], [-1]]"}
![homebrew installation](images/secondstep_home.png)
:::
...
| ![](images/Apple-Silicon.png){width="30"} chips | ![](images/intel.png){width="50" height="34"} chips |
|:---------------------------------:|:-----------------------------------:|
...
::: {layout="[[-1], [1], [-1]]"}
![](images/libopenmp.png){width="393"}
:::
...
::: {layout="[[-1], [1], [-1]]"}
![](images/libopenmpt.png){width="393"}
:::
